...
3. (optional) Change the configuration (see [here](#configuration_options))
...
2. Call `qmake`, the configuration tool of Qt: `/path/to/qmake  path/to/project  [options]`.
    ...
    - You can also change some configuration options, which you can find [here](#configuration_options).
3. Call `make`
