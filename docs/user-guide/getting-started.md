...
- [Platform notes: Windows](platformm-windows.md)
- [Platform notes: Linux](platformm-linux.md) (also see for Raspberry Pi)
- [Platform notes: Android](platformm-android.md)
